...
the target website. You must make your program generate a QR code that takes someone to your GitHub homepage i.e. https://github.com/sso927 (replace mine with yours)
...
![QRCode](qr_codes/QRCode_20241101134147.png)

2.  Add an image of viewing the log of successfully creating the QR code below.

![QRCode](docker_log.png)
